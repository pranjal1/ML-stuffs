...
def L_layer_model(X, Y, layers_dims, learning_rate = 1.2, num_iterations = 3000, print_cost=False):#lr was 0.2 for blobs and [2,2,1], lam =1 worked
...
train_x, valid_x, train_y, valid_y = model_selection.train_test_split(trainDF['images'], trainDF['label'],test_size = 0.8,random_state=42, stratify=trainDF['label']) #20-80 split, stratified sampling
...
parameters = L_layer_model(X_train, y_encoded, layers_dims, num_iterations = 1500, print_cost = True)
#tomorrow
